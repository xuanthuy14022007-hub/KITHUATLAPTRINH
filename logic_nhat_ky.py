...
def lay_nhat_ky_theo_mua_vu(activity_id):
    """
    Lấy danh sách nhật ký của một vụ mùa (tối đa 3 bản ghi mới nhất).
...
def ghi_nhan_thu_hoach(activity_id, harvest_quantity, log_date, note):
    """
    Ghi nhận thu hoạch: thêm nhật ký 'Thu hoạch' và cập nhật trạng thái vụ mùa thành 'Sẵn sàng bán'.
